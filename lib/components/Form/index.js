  ...
  _createClass(Form, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'form',
        _extends({}, rest, { onSubmit: this.formSubmit, noValidate: true, ref: this.setRef('form') }),
        this.props.children
      );
    }
  }]);
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.getValues = function () {
    return (0, _formSerialize2.default)(_this2.form, {
      hash: true
    });
  };
  ...
  this.submit = function () {
    ...
    var values = (0, _formSerialize2.default)(_this2.form, {
      hash: true
    });
    return (_props2 = _this2.props).onSubmit.apply(_props2, [values].concat(args));
  };
